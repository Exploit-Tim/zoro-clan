...
from bot import Bot
from config import ADMINS, FORCE_MSG, START_MSG, CUSTOM_CAPTION, DISABLE_CHANNEL_BUTTON, PROTECT_CONTENT, START_PIC, FORCE_PIC
    ...
    buttons = [ 
        [
           InlineKeyboardButton(
                "Join Channel",
                url = "https://t.me/Shirohige_Animes"),
            InlineKeyboardButton(
                "Join Channel",
